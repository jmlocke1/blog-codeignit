  ...
  <script src="<?php echo site_url(); ?>assets/js/jquery-migrate-3.0.1.min.js"></script>
  ...
  <script src="<?php echo site_url(); ?>assets/js/jquery.animateNumber.min.js"></script>
  <script src="<?php echo site_url(); ?>assets/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?php echo site_url(); ?>assets/js/google-map.js"></script>
